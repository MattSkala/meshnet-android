...
class BleL2CapConnectivityManager(
    ...
    override fun createBluetoothSocket(device: BluetoothDevice): BluetoothSocket {
        // TODO: retrieve PSM from advertising message
        val psm = 0
        return device.createInsecureL2capChannel(psm)
    }

    override fun createBluetoothServerSocket(): BluetoothServerSocket {
        val serverSocket = bluetoothAdapter.listenUsingL2capChannel()
        val psm = serverSocket.psm
        // TODO: add PSM to advertising message
        return serverSocket
    }

    companion object : SingletonHolder<BleL2CapConnectivityManager, Context>(::BleL2CapConnectivityManager) {
